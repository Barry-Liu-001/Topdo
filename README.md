...
![Version](https://img.shields.io/badge/version-v2.0.0-2563eb?style=flat-square)
...
- [下载 Topdo v2.0.0 macOS Universal DMG](https://github.com/SkyNone/Topdo/releases/download/v2.0.0/Topdo_2.0.0_universal.dmg)
- [查看 v2.0.0 Release](https://github.com/SkyNone/Topdo/releases/tag/v2.0.0)
...
[下载 `Topdo_2.0.0_universal.dmg`](https://github.com/SkyNone/Topdo/releases/download/v2.0.0/Topdo_2.0.0_universal.dmg)，拖拽 `Topdo.app` 到 `Applications`。
...
- `.dmg`：`src-tauri/target/universal-apple-darwin/release/bundle/dmg/Topdo_2.0.0_universal.dmg`
